...
import {NavbarBrand, Nav, Button, Navbar, Container, Modal, ModalTitle, ModalBody, FormGroup, FormLabel, FormControl, FormText, FormCheck } from 'react-bootstrap'
...
const Styles = styled.div `
    a, .navbar-brand, .navbar-nav, navar-link {
        color: #adb1b8;
       &:hover{
           color: white
       } 
